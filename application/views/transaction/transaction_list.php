...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="col-md-6 ">
                <?php echo anchor(site_url('transaction/create'), 'Tambah Data', 'class="btn btn-primary"'); ?>
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    columns: [
                        ...
                        {"data": "transaction_status"},{"data": "transaction_time"},{"data": "user_ID"},{"data": "destination_address"},{"data": "information"},
                        {
                            "data" : "action",
                            "orderable": false,
