...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('".$c_url."/read/\$1'),'
            <button type=\"button\" class=\"btn btn-primary\">
                <span class=\"glyphicon glyphicon-eye-open\" aria-hidden=\"true\"></span>
            </button>').\"\".anchor(site_url('".$c_url."/update/\$1'),'
            <button type=\"button\" class=\"btn btn-success\">
                <span class=\"glyphicon glyphicon-edit\" aria-hidden=\"true\"></span>
            </button>').\"\".anchor(site_url('".$c_url."/delete/\$1'),'
            <button type=\"button\" class=\"btn btn-danger\">
                <span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span>
            </button>','onclick=\"javasciprt: return confirm(\\'Anda yakin ingin menghapus data ini ?\\')\"'), '$pk');
